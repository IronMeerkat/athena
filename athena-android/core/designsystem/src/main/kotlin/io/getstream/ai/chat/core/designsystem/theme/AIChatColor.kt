 ...
 */
package com.ironmeerkat.athena.core.designsystem.theme
...
public data class AIChatColor(
  ...
  public companion object {
     ...
     *
     * @return A [AIChatColor] instance holding our color palette.
     */
    @Composable
    public fun defaultColors(): AIChatColor = AIChatColor(
      primary = Primary,
      secondary = Color(0xFF6644FF),
      background = Color.White,
      error = Color(0xFFe93c3c),
      tertiary = Color(0xFFC098F5),
     ...
     */
    @Composable
    public fun defaultDarkColors(): AIChatColor = AIChatColor(
      primary = Primary,
      secondary = Color(0xFF6644FF),
...
public val Item: Color = Color(0xFF212121)
