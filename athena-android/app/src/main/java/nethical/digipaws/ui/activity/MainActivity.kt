...
//                makeStartFocusModeDialog()
    ...
    private fun setupClickListeners() {
        ...
        binding.btnCredits.setOnClickListener { openUrl("https://digipaws.life/credits") }
        binding.btnBackup.setOnClickListener { ZipUtils.showDirectoryPicker(directoryPicker) }
        binding.helpReelBlocker.setOnClickListener { /* keep minimal help */ }
