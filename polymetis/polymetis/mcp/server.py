...
from polymetis.tasks.run_graph import run_graph
from polymetis.tasks.agents import (
    list_public_agents,
    list_sensitive_agents,
)
from polymetis.tools.registry import SENSITIVE_TOOLS, PUBLIC_TOOLS
# Ensure policy tools register on import
from polymetis.tools.policies import (  # noqa: F401
    __init__ as _policy_tools,
)
# Ensure mongo tool registers on import
from polymetis.tools import mongo_admin  # noqa: F401
...
def main() -> None:
    async def _run() -> None:
        ...
        logger.info("Initializing MCP stdio server (polymetis)")
