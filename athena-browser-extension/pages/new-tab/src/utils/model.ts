...
type LLMModel = {
  ...
  available: boolean;
  sorted: number;
  provider?: { id: string; providerName: string; providerType: string; sorted: number };
  displayName?: string;
  isDefault?: boolean;
};
...
export function isModelAvailableInServer(
  ...
  const modelTable = collectModelTable(DEFAULT_MODELS as unknown as readonly LLMModel[], customModels);
